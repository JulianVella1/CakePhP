...
return [
     ...
     */
    'Error' => [
        'errorLevel' => E_ALL & ~E_USER_DEPRECATED,//AI Assistance as I was confused about error levels
        'skipLog' => [],
        'log' => true,
        'trace' => true,
    ...
    'Log' => [
        ...
        //created my own log file for testing and ease of access, to many distraction in debug log
        'julian' => [
            'className' => FileLog::class,
            'path' => LOGS,
            'file' => 'julian',
